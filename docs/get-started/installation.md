...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.5.0/LaraDumps-4.5.0-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.5.0/LaraDumps-4.5.0.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.5.0.AppImage && ./LaraDumps-4.5.0.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.5.0/LaraDumps-Setup-4.5.0.exe)
