...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.6.2/LaraDumps-4.6.2-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.6.2/LaraDumps-4.6.2.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.6.2.AppImage && ./LaraDumps-4.6.2.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.6.2/LaraDumps-Setup-4.6.2.exe)
