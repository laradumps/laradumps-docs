...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.8/LaraDumps-4.0.8-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.8/LaraDumps-4.0.8.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.0.8.AppImage && ./LaraDumps-4.0.8.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.8/LaraDumps-Setup-4.0.8.exe)
