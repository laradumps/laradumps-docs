...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.13.10/LaraDumps-4.13.10-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.13.10/LaraDumps-4.13.10.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.13.10.AppImage && ./LaraDumps-4.13.10.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.13.10/LaraDumps-Setup-4.13.10.exe)
