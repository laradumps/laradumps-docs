...
Click to [`Download LaraDumps v2.2.0`](https://github.com/laradumps/app/releases/download/v2.2.0/LaraDumps-Setup-2.2.0.exe) installer for Windows.
...
Click to [`Download LaraDumps v2.2.0`](https://github.com/laradumps/app/releases/download/v2.2.0/LaraDumps-2.2.0.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-2.2.0.AppImage && ./LaraDumps-2.2.0.AppImage
```
...
Click to [`Download LaraDumps v2.2.0`](https://github.com/laradumps/app/releases/download/v2.2.0/LaraDumps-2.2.0-universal.dmg) Apple Disc Image (.dmg) for macOS.
