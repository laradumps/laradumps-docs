...
Click to [`Download LaraDumps v2.4.1`](https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-Setup-2.4.1.exe) installer for Windows.
...
Click to [`Download LaraDumps v2.4.1`](https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-2.4.1.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-2.4.1.AppImage && ./LaraDumps-2.4.1.AppImage
```
...
Click to [`Download LaraDumps v2.4.1`](https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-2.4.1-universal.dmg) Apple Disc Image (.dmg) for macOS.
