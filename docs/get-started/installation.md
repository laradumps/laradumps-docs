...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.4.1/LaraDumps-4.4.1-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.4.1/LaraDumps-4.4.1.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.4.1.AppImage && ./LaraDumps-4.4.1.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.4.1/LaraDumps-Setup-4.4.1.exe)
