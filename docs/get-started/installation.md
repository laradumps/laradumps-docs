...
[Download latest version here](https://github.com/laradumps/app/releases/download/v3.5.0/LaraDumps-3.5.0-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v3.5.0/LaraDumps-3.5.0.AppImage)
...
```shell
chmod u+x ./LaraDumps-3.5.0.AppImage && ./LaraDumps-3.5.0.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v3.5.0/LaraDumps-Setup-3.5.0.exe)
