...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.12/LaraDumps-4.0.12-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.12/LaraDumps-4.0.12.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.0.12.AppImage && ./LaraDumps-4.0.12.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.12/LaraDumps-Setup-4.0.12.exe)
