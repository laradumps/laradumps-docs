...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.9/LaraDumps-4.0.9-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.9/LaraDumps-4.0.9.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.0.9.AppImage && ./LaraDumps-4.0.9.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.9/LaraDumps-Setup-4.0.9.exe)
