...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.5/LaraDumps-4.0.5-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.5/LaraDumps-4.0.5.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.0.5.AppImage && ./LaraDumps-4.0.5.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.5/LaraDumps-Setup-4.0.5.exe)
