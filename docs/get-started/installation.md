...
Click to [`Download LaraDumps v2.4.2`](https://github.com/laradumps/app/releases/download/v2.4.2/LaraDumps-Setup-2.4.2.exe) installer for Windows.
...
Click to [`Download LaraDumps v2.4.2`](https://github.com/laradumps/app/releases/download/v2.4.2/LaraDumps-2.4.2.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-2.4.2.AppImage && ./LaraDumps-2.4.2.AppImage
```
...
Click to [`Download LaraDumps v2.4.2`](https://github.com/laradumps/app/releases/download/v2.4.2/LaraDumps-2.4.2-universal.dmg) Apple Disc Image (.dmg) for macOS.
