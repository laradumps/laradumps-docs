...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.10.4/LaraDumps-4.10.4-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.10.4/LaraDumps-4.10.4.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.10.4.AppImage && ./LaraDumps-4.10.4.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.10.4/LaraDumps-Setup-4.10.4.exe)
