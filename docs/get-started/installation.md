...
[Download latest version here](https://github.com/laradumps/app/releases/download/v3.6.0/LaraDumps-3.6.0-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v3.6.0/LaraDumps-3.6.0.AppImage)
...
```shell
chmod u+x ./LaraDumps-3.6.0.AppImage && ./LaraDumps-3.6.0.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v3.6.0/LaraDumps-Setup-3.6.0.exe)
