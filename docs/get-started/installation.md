...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.11/LaraDumps-4.0.11-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.11/LaraDumps-4.0.11.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.0.11.AppImage && ./LaraDumps-4.0.11.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.11/LaraDumps-Setup-4.0.11.exe)
