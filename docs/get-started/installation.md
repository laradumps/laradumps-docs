...
Click to [`Download LaraDumps v2.1.3`](https://github.com/laradumps/app/releases/download/v2.1.3/LaraDumps-Setup-2.1.3.exe) installer for Windows.
...
Click to [`Download LaraDumps v2.1.3`](https://github.com/laradumps/app/releases/download/v2.1.3/LaraDumps-2.1.3.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-2.1.3.AppImage && ./LaraDumps-2.1.3.AppImage
```
...
Click to [`Download LaraDumps v2.1.3`](https://github.com/laradumps/app/releases/download/v2.1.3/LaraDumps-2.1.3-universal.dmg) Apple Disc Image (.dmg) for macOS.
