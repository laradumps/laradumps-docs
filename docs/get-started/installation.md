...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.6/LaraDumps-4.0.6-universal.dmg )
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.6/LaraDumps-4.0.6.AppImage)
...
```shell
chmod u+x ./LaraDumps-4.0.6.AppImage && ./LaraDumps-4.0.6.AppImage
```
...
[Download latest version here](https://github.com/laradumps/app/releases/download/v4.0.6/LaraDumps-Setup-4.0.6.exe)
