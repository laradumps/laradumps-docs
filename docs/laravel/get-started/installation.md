...
Click to [`Download LaraDumps v1.5.1`](https://github.com/laradumps/app/releases/download/v1.5.1/LaraDumps-Setup-1.5.1.exe) installer for Windows.
...
Click to [`Download LaraDumps v1.5.1`](https://github.com/laradumps/app/releases/download/v1.5.1/LaraDumps-1.5.1.AppImage) application image for Linux.
...
```shell
chmod u+x ./LaraDumps-1.5.1.AppImage && ./LaraDumps-1.5.1.AppImage
```
...
Click to [`Download LaraDumps v1.5.1`](https://github.com/laradumps/app/releases/download/v1.5.1/LaraDumps-1.5.1-universal.dmg) Apple Disc Image (.dmg) for macOS.
